...
<meta charset="utf-8">
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="sandy323.png">
    <link rel="icon" type="image/png" sizes="32x32" href="sandy323.png">
    <link rel="icon" type="image/png" sizes="16x16" href="sandy323.png">
...
<body style="background-color:#008080; padding-top:8%;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="sec/myself1.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; ">SANDEEP KU YADAV</h1>
            <p style="color:white;"><b>Intern at Sparks Foundation <br>National Institute of Technology Raipur</b></p>
    </center>
