...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="sec/sandy323.png">
    <link rel="icon" type="image/png" sizes="32x32" href="sec/sandy323.png">
    <link rel="icon" type="image/png" sizes="16x16" href="sec/sandy323.png">
...
<body style="background-color:#deb954;">
<div id="container">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
    style="font-family:candara; font-size:18px; box-shadow: 0px 0px 20px 0px blue;">
    <div class="container-fluid">
        <a href="index.php"><img src="sec/sandy323.png" alt=""
...
<div style="color:white; height:200px; width: 100%; padding:10% 2% 2% 2%; background-color:#7979ad;">
    <h1  style="animation-direction: alternate-reverse; text-align:center; text-shadow: 2px 2px black">WELCOME TO SPARK BANK</h1>
</div>

<center style="margin:60px 0px 20px 0px; background-color:#424085;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px blue; border-radius:30px; padding:20px 0px 20px 0px; background-color:white;">
            <h1 style="text-shadow:2px 2px 2px gray; color:#7cec1c;"><b>Services</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        ...
                        <img style="border-radius: 50%;" src="sec/rt.png" alt="" width="130" height="130"><br><br>
